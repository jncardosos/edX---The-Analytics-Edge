...
# Read in the data
stevens = read.csv("unit_04/00_data/stevens.csv")
str(stevens)
...
StevensTree4 = rpart(Reverse ~ Circuit + Issue + Petitioner + Respondent + LowerCourt + Unconst, data = Train, method="class", minbucket=100)
Pred4 = predict(StevensTree4, newdata = Test, type = "class")
table(Test$Reverse, Pred4)
(59+64)/(59+64+18+29)
